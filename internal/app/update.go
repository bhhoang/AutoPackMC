...
// UpdateInfo describes the newest AutoPack release.
...
const updateUserAgent = "AutoPack-updater"
...
// CheckForUpdate asks GitHub for the newest AutoPack release.
func (s *Service) CheckForUpdate() (*UpdateInfo, error) {
	...
	want := fmt.Sprintf("AutoPack-%s-%s-%s.exe", body.TagName, goruntime.GOOS, goruntime.GOARCH)
