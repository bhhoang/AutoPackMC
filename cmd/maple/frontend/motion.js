...
//  - a glass lens under the active item of a group, painted with layered
//    gradients and rim highlights. It has no backdrop-filter of its own:
//    lenses inside frosted cards made some Windows graphics drivers draw
//    strips of the wrong backdrop in nearby cards while a lens moved;
...
(() => {
  ...
  function place(L, animate){
    ...
    anim.finished.then(() => { if (L.anim === anim) L.anim = null; }, () => {});
  }
